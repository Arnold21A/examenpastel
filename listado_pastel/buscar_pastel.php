 ...
 <a href="salir.php"><img class="close" src="Img/cerrar cesion.png" alt="Cerrar"></a>
     ...
     <div class="menu">    
        ...
        <section id="container">
            ...
            if(empty($busqueda))
            {
                header("location: listado_pastel.php");
            }
            ...
            <tr>
                    ...
                    <td>
                        <a class="link_edit" href="../pastel/editar_pastel.php?id=<?php echo $data["idusuario"]; ?>">Editar</a>
                        
                        <?php if($data["idusuario"] != 1){

                            ?>
                            |                        
                        <a class="link_delete" href="../inicio/elimina_pastel.php?id=<?php echo $data["idusuario"]; ?>">Eliminar</a>
