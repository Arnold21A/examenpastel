 ...
 <a href="salir.php"><img class="close" src="Img/cerrar cesion.png" alt="Cerrar"></a>
     ...
     <div class="menu">    
			...
			<ul>
				...
				<li class="principal">
					...
					<ul>
						...
						<li><a href="listado_ingrediente.php">Lista de Ingredientes</a></li>
					</ul>
				</li>
        ...
        <section id="container">
            ...
            <a href="../ingrediente/registro_ingrediente.php" class="btn_new">Crear Ingrediente</a>
            ...
            <table>
                ...
                //$sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM ingrediente");
               ...
               // }
                ...
                $query = mysqli_query($conection,"SELECT* FROM ingrediente ");
            ...
            <tr>
                    <td><?php echo $data["id_ingrediente"]; ?></td>
                    ...
                    <td>
                        <a class="link_edit" href="../ingrediente/editar_ingrediente.php?id=<?php echo $data["id_ingrediente"]; ?>">Editar</a>
                        
                     
                            |                        
                        <a class="link_delete" href="../inicio/elimina_ingrediente.php?id=<?php echo $data["id_ingrediente"]; ?>">Eliminar</a>
